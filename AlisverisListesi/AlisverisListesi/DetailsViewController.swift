...
//  AlisverisListesi
//
//  Created by Erbil Can on 4.07.2022.
//
...
class DetailsViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if secilenUrunIsmi != "" {
            ...
            //coredatada ki seçilen ürünün bilgilerini göstereceğiz
            if let uuidString = secilenUrunUUID?.uuidString{
                
                let appDelegate = UIApplication.shared.delegate as! AppDelegate
                let context = appDelegate.persistentContainer.viewContext
                let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "Alisveris")
                fetchRequest.predicate = NSPredicate(format: "id = %@", uuidString)  // mantıksal bazı sınırlar koyacaksınız ve arama buna göre yapılacak
            ...
            //burada da her ihtimale karşı butonu aktif ediyoruz normalde çalışıyor zaten ama ne olur ne olmaz diye
            kaydetButton.isHidden = false
            kaydetButton.isEnabled = false
            //bir ürün seçilmemiş şekilde geliyor demektir
            isimTextField.text = ""
            fiyatTextField.text = ""
            bedenTextField.text = ""
        }
    ...
    @IBAction func kaydetButton(_ sender: Any) {
        ...
        do{
            ...
            print("Kayıt edilemedi, Hata var!!!")
        }
        
        //veri kaydettim bilgisini diğer kaynaklara haber veriyoruz
        
        NotificationCenter.default.post(name: NSNotification.Name("veriGirildi"), object: nil)
        
        // navigasyonu göstererek bir önceki sayfaya animasyonlu olarak geri dönemesini söylüyoruz
