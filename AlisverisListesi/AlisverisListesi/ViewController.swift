...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //giriş ekranındaki '+' işaretini yukarıdaki gibi ekledik
    ...
    //observer kim self yani controllerın kendisi, name=details deki notification ksımında verilen name girildi
    ...
    @objc func verileriAl(){
        ...
        let context = appDelegation.persistentContainer.viewContext
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        // silme işlemi yapılıyor mu kontrolü yapıyoruz altta
